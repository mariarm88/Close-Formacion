 ...
 * Description: Esto es una demo de un plugin.
 * Version:     1.0.0
 * Author:      Mari Romero
...
// Include files.
require_once DECL_PLUGIN_PATH . 'includes/theme/post-types/cursos.php';
require_once DECL_PLUGIN_PATH . 'includes/theme/post-types/profesores.php';
require_once DECL_PLUGIN_PATH . 'includes/theme/post-types/centros.php';
require_once DECL_PLUGIN_PATH . 'includes/theme/functions.php';
